...
dbdir="/db"
output1="TCGA_Expression_and_junction_imputation.dat" #Gene-disease association

## list of tissues:
#"OV.GE.NORMAL_FTSEC" "OV.GE.NORMAL_OSEC" "TCGA_OV.GE.TUMOR" "TCGA_OV.SP.TUMOR" "TCGA_BRCA.GE.NORMAL" "TCGA_BRCA.SP.NORMAL" "TCGA_BRCA.GE.TUMOR" "TCGA_BRCA.SP.TUMOR" "TCGA_PRAD.GE.TUMOR" "TCGA_PRAD.SP.TUMOR"
...
tissue="Expression_and_junction/"${weights}".pos"
...
#./scripts/script_TCGA_Expression_and_junction.sh ../PGC2.SCZ.sumstats test1 OV.GE.NORMAL_FTSEC eur 22 100000 0 0.5  0.7 2500 0 0 

# 2. with permuatation --- # Significance conditional on high GWAS effects (permutation test)
#./scripts/script_TCGA_Expression_and_junction.sh ../PGC2.SCZ.sumstats test2 TCGA_PRAD.SP.TUMOR afr 22 100000 0 0.5  0.7 2500 0 100  0.05 
...
--weights_dir ${dbdir}/WEIGHTS/Expression_and_junction \
