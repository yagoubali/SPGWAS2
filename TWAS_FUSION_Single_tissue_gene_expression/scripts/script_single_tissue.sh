...
#./scripts/script_single_tissue.sh ../PGC2.SCZ.sumstats test1 NTR.BLOOD.RNAARR eur 22 100000 0 0.5  0.7 2500 0 0 True

# 2. with permuatation --- # Significance conditional on high GWAS effects (permutation test)
#./scripts/script_single_tissue.sh ../PGC2.SCZ.sumstats test2 CMC.BRAIN.RNASEQ_SPLICING afr 22 100000 0 0.5  0.7 2500 0 100  0.05 False
